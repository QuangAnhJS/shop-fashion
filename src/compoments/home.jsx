    ...
    {loading&&(<Loading/>)}
      ...
      <section className="container-fluid">
        <div className="cs_slider position-relative">
          ...
          <div className="cs_slides_numbers">
            ...
            <span className="cs_total_slide"></span>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="container-fluid">
          <div className="cs_height_75 cs_height_lg_75"></div>
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="cs_iconbox cs_style_1 position-relative">
                ...
                <div className="cs_iconbox_text">
                  ...
                  <p className="cs_iconbox_subtitle mb-0">
                    Thanh toán trực tuyến dễ dàng không rắc rối
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-sm-6">
              <div className="cs_iconbox cs_style_1 position-relative">
                ...
                <div className="cs_iconbox_text">
                  ...
                  <p className="cs_iconbox_subtitle mb-0">24/7 nhanh chóng</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-sm-6">
              <div className="cs_iconbox cs_style_1 position-relative">
                ...
                <div className="cs_iconbox_text">
                  ...
                  <p className="cs_iconbox_subtitle mb-0">
                    Mỗi đơn hàng được đóng gói một cách cẩn thận an toàn
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="row cs_gap_y_24">
        <div className="col-sm-6">
          <div className="cs_category cs_style_1">
            <a href="shop.php" className="cs_category_thumb position-relative">
              <img src={v2} alt="Category Image" className="w-100" />
      ...
      <section className="cs_gray_bg">
        ...
        <div className="container">
          <h2 className="cs_section_title cs_fs_50 cs_bold mb-0 text-center">
            Những gì người dùng của chúng tôi nói
          </h2>
        </div>
        ...
        <div className="cs_slider position-relative">
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  <div className="slick_slide_in">
                    <div className="cs_testimonial cs_style_1 text-center">
                      <blockquote className="cs_testimonial_text cs_fs_21 cs_semibold">
                        Mua sắm tại Fashion King Men thực sự là một niềm vui
                        tuyệt vời!
                        <br />
                        Tôi đã là khách hàng trong suốt năm qua, và tôi tự tin
                        nói rằng đây là địa điểm mua sắm trực tuyến ưa thích của
                        tôi.
                        <br />
                        Rất đề xuất!
                      </blockquote>
                      <div className="cs_testimonial_user">
                        ...
                        <h4 className="cs_avatar_title cs_fs_21 cs_semibold mb-0">
                          Anh Quang
                        </h4>
                        <p className="cs_avatar_subtitle mb-0">From BacKan</p>
                      </div>
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_testimonial cs_style_1 text-center">
                      <blockquote className="cs_testimonial_text cs_fs_21 cs_semibold">
                        Tôi đã khám phá thế giới thời trang nam qua Fashion King
                        Men và tôi không thể hạnh phúc hơn với những gì tôi đã
                        trải qua.
                        <br />
                        Sản phẩm chất lượng, kiểu dáng đa dạng và dịch vụ khách
                        hàng nhanh chóng. Đặc biệt,
                        <br />
                        tôi rất ấn tượng với chất liệu của áo thun cotton -
                        thoải mái và bền.
                        <br />
                        Fashion King Men chắc chắn là địa chỉ thời trang nam
                        hàng đầu.
                      </blockquote>
                      <div className="cs_testimonial_user">
                        <div className="cs_avatar_thumb">
                  ...
                  <div className="slick_slide_in">
                    <div className="cs_testimonial cs_style_1 text-center">
                      <blockquote className="cs_testimonial_text cs_fs_21 cs_semibold">
                        Tôi đã tìm thấy sự sang trọng và phong cách trong mỗi
                        sản phẩm từ Fashion King Men.
                        <br />
                        Đặc biệt, bộ sưu tập mùa đông với áo khoác làm từ vật
                        liệu chống nước là lựa chọn hoàn hảo.
                        <br />
                        Chất lượng tốt, giá trị đáng kinh ngạc, và họ thường
                        xuyên có các ưu đãi hấp dẫn.
                        <br />
                        Chắc chắn sẽ tiếp tục mua sắm tại đây.
                      </blockquote>
                      <div className="cs_testimonial_user">
                        <div className="cs_avatar_thumb">
          ...
          <div className="cs_slider_arrows cs_style_1 cs_hide_mobile"></div>
      ...
      <section>
        ...
        <div className="container">
          <div className="cs_section_heading cs_style_1">
            <div className="cs_section_heading_in">
              <h2 className="cs_section_title cs_fs_50 cs_bold mb-0">
                Đọc bộ sưu tập thời trang độc quyền của chúng tôi.
              </h2>
            </div>
          ...
          <div className="row cs_gap_y_30">
            <div className="col-lg-4">
              <div className="cs_post cs_style_1">
                <a href="blog_details.php" className="cs_post_thumb cs_zoom">
                  <img
                    src={post}
                    alt="Post Image"
              ...
              <div className="cs_post cs_style_1">
                ...
                <div className="cs_post_info">
                  ...
                  <p className="cs_post_subtitle">
                    ...
                    your choices can have a positive impact on the planet. From
                    eco-friendly fabrics to ethical brands...
                  </p>
                  <a
                    href="blog_details.php"
                    className="cs_post_btn cs_fs_16 cs_medium cs_primary_color"
            ...
            <div className="col-lg-4">
              <div className="cs_post cs_style_1">
                ...
                <div className="cs_post_info">
                  ...
                  <p className="cs_post_subtitle">
                    Pattern mixing can be a style statement, but it can also be
                    intimidating. Learn the art of combining different patterns
                    and prints to create unique and eye-catching outfits....
                  </p>
                  <a
                    href="blog_details.php"
                    className="cs_post_btn cs_fs_16 cs_medium cs_primary_color"
      ...
      <div className="cs_instagram">
        ...
        >
          ...
          <div className="cs_instagram_overlay position-absolute">
